...
function compareChoices() {
    ...
    if (computer.choice === player.choice) {
        ...
        document.getElementById('resultsDiv').appendChild(results);
    } else if (computer.choice === choices[0] && player.choice === choices[2] || computer.choice === choices[2] && player.choice === choices[1] || computer.choice === choices[1] && player.choice === choices[0]) {
